...
install-brew:
    ...
    # if /etc/profile.d/brew.sh already exists, replace it with /home/slimbook/Downloads/brew.sh
    if [ -f /etc/profile.d/brew.sh ]; then
        if [ -f /home/slimbook/Downloads/brew.sh ]; then
            sudo cp /home/slimbook/Downloads/brew.sh /etc/profile.d/brew.sh
        fi
    fi
